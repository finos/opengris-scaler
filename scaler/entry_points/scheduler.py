...
from scaler.config.config import SchedulerConfig, ObjectStorageConfig
...
def main():
    ...
    scheduler_config = SchedulerConfig.get_config(args.config, args)
    ...
    if args.object_storage_address is None:
        ...
        object_storage_address = scheduler_config.storage_address
        object_storage = None
