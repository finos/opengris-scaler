...
class StreamingBuffer(io.StringIO):
    ...
    def __init__(self, task_id: TaskID, stream_type: TaskLog.Stream, connector_agent: SyncConnector):
        super().__init__()
    ...
    def write(self, content: str) -> int:
        ...
        with self._lock:
            ...
            if content:
                try:
                    self._connector_agent.send(TaskLog.new_msg(self._task_id, self._stream_type, content))
