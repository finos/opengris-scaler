...
function(scaler_add_python_module)
    ...
    if(WIN32)
        # Python 3.8+ on Windows uses secure DLL loading and ignores PATH for extension imports.
        # Install dependent runtime DLLs (e.g. uv.dll) next to the .pyd so the loader finds them.
        # Excludes system DLLs (api-ms-*, kernel32, etc.).
        install(
            FILES $<TARGET_RUNTIME_DLLS:${PYMOD_TARGET}>
            DESTINATION ${PYMOD_INSTALL_DEST}
        )
    endif()
endfunction()
